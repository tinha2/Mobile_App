...
let API_KEY : String = "AIzaSyBGx3xaGI7FFUBA1ZlfqihZmU36rR8lWQI"
  ...
  func streamAudioData(_ audioData: NSData, completion: @escaping SpeechRecognitionCompletionHandler) {
    if (!streaming) {
      ...
      // authenticate using an API key obtained from the Google Cloud Console
        call.requestHeaders.setObject(NSString(string:Google_Cloud_Key),
                                      forKey:NSString(string:"X-Goog-Api-Key"))
//        call.requestHeaders.setObject(NSString(string:"application/json; charset=utf-8"),
//                                    forKey:NSString(string:"Content-Type"))
//        call.requestHeaders.setObject(NSString(string:"Bearer \(LocalCoordinator.share.accessToken)"),
